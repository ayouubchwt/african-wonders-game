...
int main (){
    ...
    int boucle=1;
    image mxo,xo,question,l,lg,ln,ivie,tabl,tp,fire,game_over;
    image settings,mmap1,mmap2,mmap3,mmap11,mmap33,back1,back11,back2,back3,back33,backL,btnp,bk;
    Boutton BTN_START,BTN_LOAD,BTN_SETT,BTN_QUIT,BTN_SAVE,BTN_RESUME,BTN_QUIT2,reponse1, reponse2, reponse3;
    int click=1,click1=0,click2=0,click3=0,cxo=0;
    enemi enemi,monster;
    Time time;
    int k=0,i=0,con=1,cp=0;
    int v=MIX_MAX_VOLUME,maxi=100;
    int current_map_level=1,maxi0=0,maxi1=3;
    ...
    Enigme e = generer("./enigme/enigme.txt");
    int score=100,vie=3;
    int etat_enigme=-1;
    int reponse=-1;
    Uint32 start_time;
    ...
    initialiser_Boutton(&reponse1,e.rep1,e.rep11,157,327,1);
    initialiser_Boutton(&reponse2,e.rep2,e.rep22,166,403,2);
    initialiser_Boutton(&reponse3,e.rep3,e.rep33,176,448,3);
    ...
    {                                     
        ...
        if(click1==1)
        {
            ...
            if (maxi1==0)
            {
                    ...
                    { 
                        ...
                        case SDL_MOUSEBUTTONDOWN:
                            ...
                            else if (event.button.button==SDL_BUTTON_LEFT && (event.motion.y<=562 && event.motion.y>=522 && event.motion.x<=590 && event.motion.x>529))
                            {
                                ...
                                reponse=-1,time_left= 20,con1=1,ee=1,con2=1,n=0,tt=1,cf=0,conf,etat_enigme=-1;
                ...
                if(current_map_level==2)
                {
                    if((perso.position.x==100)&&(perso.position.y==330))
                    {
                        maxi1=0;
                        perso.position.y=SCREEN_H-250;
                        
                    }
                    if(((perso.position.x==120)||(perso.position.x==210))&&(perso.position.y==250))
                    {
                        maxi1=0;
                        perso.position.y=SCREEN_H-250;
                        
                    }
                    if(((perso.position.x==260)||(perso.position.x==340))&&(perso.position.y==240))
                    {
                        maxi1=0;
                        perso.position.y=SCREEN_H-250;
                    
                    }
                    if(((perso.position.x==380)||(perso.position.x==470))&&(perso.position.y==250))
                    {
                        maxi1=0;
                        perso.position.y=SCREEN_H-250;
                       
                    }
                    if(((perso.position.x==500)||(perso.position.x==590))&&(perso.position.y==240))
                    {
                        maxi1=0;
                        perso.position.y=SCREEN_H-250;
                ...
                /*if((perso.position.x==214)&&(ee==1)&&(current_map_level==1)){
                    etat_enigme=1;
                ...
                if((etat_enigme==1)&&(time_left!=-1))
                {
                    ...
                    afficher_boutton(event,&reponse1,screen);
                    afficher_boutton(event,&reponse2,screen);
                    afficher_boutton(event,&reponse3,screen);
                    ...
                    while (SDL_PollEvent(&event)) {
                        switch(event.type)
                        {
                            ...
                            case SDL_MOUSEBUTTONDOWN:
                                if ((event.motion.y <= reponse1.Img[0]->h + 327 && event.motion.y >= 327) && (event.motion.x <= reponse1.Img[0]->w + 157 && event.motion.x >= 157))
                                {
                                    reponse=1;
                                }
                                else if ((event.motion.y <= reponse2.Img[0]->h + 403 && event.motion.y >= 403) && (event.motion.x <= reponse2.Img[0]->w + 155 && event.motion.x >= 155))
                                {
                                    reponse=2;
                                }
                                else if ((event.motion.y <= reponse3.Img[0]->h + 448 && event.motion.y >= 448) && (event.motion.x <= reponse3.Img[0]->w + 176 && event.motion.x >= 176))
                                {
                                    reponse=3;
                                }
                                break;
                    ...
                    if((reponse!=-1)||(time_left==0))
                            etat_enigme=0;
                }

                if ((etat_enigme==0)&&(reponse==e.rep)){
                    resol(screen,n,lg);
                    n++;
                }
                else if ((etat_enigme==0)&&((reponse!=e.rep)||(reponse==-1))){
                    resol(screen,n,ln);
                    n++;
                }
